...
public:
    ...
    void addFile( MD5Value md5,
                  const CUL::StringWr& filePath,
                  const CUL::StringWr& fileSize,
    ...
    void getFiles( uint64_t size,
                   const CUL::StringWr& md5,
                   std::vector<FileInfo>& out ) const;
    void getFiles( uint64_t size, std::vector<FileInfo>& out ) const;

    void getFilesMatching( const CUL::StringWr& fileSize,
                           const CUL::StringWr& md5,
                           std::list<CUL::StringWr>& out ) const;
    CacheUsage getCacheUsage() const;

    void getListOfPossibleDuplicates(
...
private:
    ...
    void updateCache();
    void getFilesFromDB( uint64_t size,
                         const CUL::StringWr& md5,
                         std::vector<FileInfo>& out ) const;
    ...
    void addFileImpl( ELockType inLockType,
                      MD5Value md5,
                      const CUL::StringWr& filePath,
                      const CUL::StringWr& fileSize,
                      const CUL::StringWr& modTime );
    ...
    std::optional<FileInfo> getFileInfo_Impl( ELockType inLockType,
                                              const CUL::StringWr& path ) const;
